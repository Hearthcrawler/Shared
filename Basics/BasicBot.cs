...
namespace HREngine.Basics
{
   public class BasicBot : IBot
   {
      ...
      protected virtual bool IsDefaultHealingEnabled()
      {
         return true;
      }
      ...
      protected Dictionary<int, HRCard> RejectedCardList;

      protected PlayCardAction NextFixedAction { get; set; }
   }
   ...
   public class PlayerState
   {
      ...
      public List<HREntity> MinionList { get; private set; }
